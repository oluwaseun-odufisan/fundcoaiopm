// This model connects to the SAME 'user' collection as the user-side backend.
// Both admin and user backends share the same MongoDB database.
// Do NOT rename the model — it must match 'user' exactly.
...
const userSchema = new mongoose.Schema(
    {
        ...
        otherName: { type: String, trim: true, default: '' },
        position:  { type: String, trim: true, default: '' },
        unitSector:{ type: String, trim: true, default: '' },
        email: {
            type: String,
            required: true,
            unique: true,
...
// Use the same model name 'user' as user-side
