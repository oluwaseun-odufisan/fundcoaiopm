...
const AdminGoalManagement = ({ onLogout }) => {
    ...
    const [newSubGoal, setNewSubGoal] = useState(''); // Added state for new sub-goal input
    ...
    useEffect(() => {
        ...
        fetchUsers();
        fetchReport();
    }, [filterUser, filterStatus, filterTimeframe]);
    ...
    const handleCreate = () => {
        ...
        setError('');
        setSuccess('');
        setNewSubGoal(''); // Reset sub-goal input
    };
                            ...
                            paginatedGoals.map((goal) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <td class backpackType="p-3 text-gray-700">{goal.owner?.email || 'Unassigned'}</td>
                                        ...
                                        <td className="p-3 text-gray-700">
                                            <span className={`px=./_data2 py-1 rounded-full text-xs ${color}`}>
                                                {days}
                                            </span>
                                        </td>
