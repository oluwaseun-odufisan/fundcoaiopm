        ...
        <div className="bg-white rounded-2xl shadow-sm flex flex-col">
          ...
          <header className="px-5 sm:px-6 py-4 flex flex-col sm:flex-row items-center justify-between gap-3 border-b border-gray-100">
            <div className="flex items-center gap-3">
              <ListChecks className="w-6 h-6 sm:w-7 h-7 text-blue-600" />
              <div>
                <h1 className="text-xl sm:text-2xl font-bold text-gray-900">Pending Tasks</h1>
            ...
            <button
              ...
              className="bg-blue-600 text-white px-4 sm:px-5 py-2 rounded-lg flex items-center gap-2 hover:bg-blue-700 transition-colors text-sm font-medium shadow-sm"
            >
          ...
          <div className="flex-1 overflow-y-auto p-5 sm:p-6 space-y-3">
            {sortedPendingTasks.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="text-sm text-blue-600">No pending tasks.</p>
              </div>
            ) : (
